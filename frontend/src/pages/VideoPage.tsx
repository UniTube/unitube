  ...
  return (
    <div className="min-h-screen bg-red-50 text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mt-5">
          <h1 className="text-xl font-semibold text-gray-900 leading-snug">{video.name}</h1>
          ...
          <div className="flex items-center justify-between mt-3 pb-4 border-b border-red-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">{video.author}</p>
                <p className="text-xs text-gray-400">Uploaded on {video.uploadedAt}</p>
              </div>
            </div>

            {/* File size badge */}
            <span className="text-xs text-gray-400 bg-white border border-red-100 px-3 py-1 rounded-full">
              {video.size}
            </span>
          </div>
        </div>
